...
def debug_condition_star():
    ...
    return galaxy_condition, (0, 1999999), (64, 64), 100, 2
...
def debug_condition_planet():
    ...
    return galaxy_condition, (0, 999999), (64, 64), 100, 1

def debug_condition_veins():
    galaxy_condition = {"veins_point": {"单极磁石": 200, "刺笋结晶": 400, "油": 200}}
    return galaxy_condition, (0, 9999), (64, 64), 100, 3
...
def debug_condition_good_start():
    ...
    return galaxy_condition, (0, 999999), (64, 64), 100, 2
...
def debug_condition_better_birthstar():
    ...
    return galaxy_condition, (0, 1999999), (64, 64), 100, 1
...
def debug_condition_100k_factory():
    ...
    return galaxy_condition, (0, 199999), (64, 64), 100, 3
...
def debug_condition_extreme_factory():
    ...
    return galaxy_condition, (0, 999999), (64, 64), 100, 3
